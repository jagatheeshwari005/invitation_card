      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <ScrollReveal direction="up">
          <div className="text-center mb-8">
            ...
            {badge && (
              <p
                className="font-tamilSans text-sm tracking-widest mb-2"
                style={{ color: '#C8860A' }}
              >
                ✦ {badge} ✦
              </p>
            ...
            <h2
              className="font-tamil font-bold text-2xl md:text-3xl lg:text-4xl"
              style={{ color: '#6B2E1A' }}
            >
              {title}
            </h2>
            ...
            {subtitle && (
              <p
                className="font-tamil text-base mt-1"
                style={{ color: '#9A5020' }}
              >
                {subtitle}
              </p>
          ...
          >
            ...
            <div className="p-4 md:p-6 lg:p-8">
              ...
              {quote && (
                ...
                >
                  <p
                    className="font-tamil text-sm md:text-base italic leading-relaxed"
                    style={{ color: '#7A4E06' }}
                  >
                    "{quote}"
                  </p>
              ...
              <div className="mt-4 space-y-4">
                ...
                {date && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p
                        className="font-tamilSans text-xs"
                        style={{ color: '#C8860A' }}
                      >
                        நாள்
                      </p>
                      ...
                      <p
                        className="font-tamil text-sm md:text-base font-semibold"
                        style={{ color: '#6B2E1A' }}
                      >
                        {date}
                      </p>
                ...
                <div className="mt-6 text-center">
                  ...
                  <motion.a
                    ...
                    style={{
                      ...
                      color: '#FFF8E7',
                      boxShadow:
                        '0 4px 16px rgba(200,134,10,0.4), 0 2px 8px rgba(200,134,10,0.2)',
                    }}
